 ...
 %>
            ...
            %>
                   <div id="s" style="width:400px;height:240px;border-radius:10px;border:1px solid #00ACEE;margin-bottom:100px;float:right;margin-right:400px;background:#00ACEE;">
                    ...
                    <p style="float:right;margin-right:240px;color:white">@<%=username%></p>
                       <image src="view.jsp?email=<%=email%>" style="border-radius:100px;" width="40" height="40"/>   
                       <form action="TweetAction" method="post" enctype="multipart/form-data">
