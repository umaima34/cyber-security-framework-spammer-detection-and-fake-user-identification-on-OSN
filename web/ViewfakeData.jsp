...
<html>
  ...
  <div id="bdy">
      ...
      <center>
          <h4 style="color:red"><B>VIEW FAKE DATE</B></h4>
          <table border="1" class="w3-table-all w3-hoverable" style="margin-bottom:100px;width:400px;"> 
              <tr><th>USER</th> <th>TWEET</th><th>IMAGE</th><th>DATE</th></tr>
              <%
              try{
                  ...
                  while(r.next()){
                   ...
                   <tr>
                       ...
                       <td><textarea cols="20" rows="5" style="color:red;font-weight: bold"><%=r.getString("tweet")%></textarea></td>
                      <td><image src="Fview.jsp?id=<%=r.getString("id")%>" WIDTH="80" HEIGHT="80"></td>
                     <td><%=r.getString("user")%></td>
