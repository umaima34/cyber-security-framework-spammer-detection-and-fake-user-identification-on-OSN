  ...
  <div id="bdy">
   ...
   <div id="tweets" style="width:400px;height:auto;border:none;float:right;margin-right:400px;margin-bottom: 100px; ">
       <center>
           ...
           String query="select * from ftweet where user='"+user+"'";
...
String u="update ftweet set count='"+z+"' where id='"+user+"'";
Queries.getExecuteUpdate(u);
   %>
  
   <div id="u" style="width:200px;height:50px;border:none;float:right;margin-right:60px;"><p style="float:left"><%=r.getString("user")%>  <font color="red">@<%=r.getString("user")%></font></p></div>
   <div id="u" style="width:50px;height:50px;border:none;float:left;margin-left:80px;">
      
   </div>
   <center>
       <textarea cols="30" rows="5" style="margin:0px;border:none;"><%=r.getString("tweet")%> </textarea><a href="Retweet2.jsp?id=<%=r.getString("id")%>&user=<%=r.getString("user")%>"><input type="button" value="Re Tweet"></a>
      <image src="Fview.jsp?id=<%=r.getString("id")%>" width="250" height="250" style="margin:0px;">
